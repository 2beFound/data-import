...
//            var_dump($item);
    ...
    public function testExceptionInterfaceThrownFromWriterIsCaught()
    {
        ...
        $workflow = new Workflow\StepAggregator($reader, $logger);
    ...
    public function testWorkflowThrowsExceptionIfNameNotString()
    {
        ...
        $workflow = new Workflow\StepAggregator($reader, null, new \stdClass);
    }
    ...
    protected function getWorkflow()
    {
        ...
        return new Workflow\StepAggregator($reader);
    }
}
